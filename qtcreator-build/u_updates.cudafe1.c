...
extern void launch_kernel_primal_u(float *, float *, float *, float *, float, float, float, float *, unsigned, unsigned, unsigned, int);
extern int __cudaSetupArgSimple();
extern int __cudaLaunch();
extern int __cudaRegisterBinary();
extern int __cudaRegisterEntry();
static void __sti___17_u_updates_cpp1_ii_3947bc38(void) __attribute__((__constructor__));
...
# 35 "/home/ankur/workspace/code/Superresolution/./src/kernels/u_updates.cu"
 dim3 __cuda_local_var_42949_10_non_const_block;
 dim3 __cuda_local_var_42950_10_non_const_grid;
# 35 "/home/ankur/workspace/code/Superresolution/./src/kernels/u_updates.cu"
{ (__cuda_local_var_42949_10_non_const_block.x) = 8U; (__cuda_local_var_42949_10_non_const_block.y) = 8U; (__cuda_local_var_42949_10_non_const_block.z) = 1U; }
{ __T20 = (mesh_width / (__cuda_local_var_42949_10_non_const_block.x)); __T21 = (mesh_height / (__cuda_local_var_42949_10_non_const_block.y)); { (__cuda_local_var_42950_10_non_const_grid.x) = __T20; (__cuda_local_var_42950_10_non_const_grid.y) = __T21; (__cuda_local_var_42950_10_non_const_grid.z) = 1U; } }
(cudaConfigureCall(__cuda_local_var_42950_10_non_const_grid, __cuda_local_var_42949_10_non_const_block, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z19kernel_derivative_uPfS_S_jjj(ux_, uy_, u_, stride, mesh_width, mesh_height));
{ __T22 = ((const char *)"execution failed\n"); __T23 = ((const char *)"/home/ankur/workspace/code/Superresolution/./src/kernels/u_updates.cu"); { __T24 = (cudaGetLastError()); if (0 != ((int)__T24)) { fprintf(stderr, ((const char *)"%s(%i) : cutilCheckMsg() CUTIL CUDA error : %s : %s.\n"), __T23, 38, __T22, (cudaGetErrorString(__T24))); exit((-1)); } } } 

}
# 95 "/home/ankur/workspace/code/Superresolution/./src/kernels/u_updates.cu"
void launch_kernel_primal_u( float *px,  float *py,  float *u_,  float *u,  float epsilon_u,  float tau,  float xisqr,  float *WiT_BiT_DiT_qi, 
unsigned stride,  unsigned width_up,  unsigned height_up,  int N_imgs)
{  unsigned __T25;
 unsigned __T26;
 const char *__T27;
 const char *__T28;
...
# 99 "/home/ankur/workspace/code/Superresolution/./src/kernels/u_updates.cu"
 dim3 __cuda_local_var_43013_10_non_const_block;
 dim3 __cuda_local_var_43014_10_non_const_grid;
# 99 "/home/ankur/workspace/code/Superresolution/./src/kernels/u_updates.cu"
{ (__cuda_local_var_43013_10_non_const_block.x) = 8U; (__cuda_local_var_43013_10_non_const_block.y) = 8U; (__cuda_local_var_43013_10_non_const_block.z) = 1U; }
{ __T25 = (width_up / (__cuda_local_var_43013_10_non_const_block.x)); __T26 = (height_up / (__cuda_local_var_43013_10_non_const_block.y)); { (__cuda_local_var_43014_10_non_const_grid.x) = __T25; (__cuda_local_var_43014_10_non_const_grid.y) = __T26; (__cuda_local_var_43014_10_non_const_grid.z) = 1U; } }
(cudaConfigureCall(__cuda_local_var_43014_10_non_const_grid, __cuda_local_var_43013_10_non_const_block, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z14kernel_primaluPfS_S_S_fffS_jjji(px, py, u_, u, epsilon_u, tau, xisqr, WiT_BiT_DiT_qi, stride, width_up, height_up, N_imgs));
{ __T27 = ((const char *)"execution failed\n"); __T28 = ((const char *)"/home/ankur/workspace/code/Superresolution/./src/kernels/u_updates.cu"); { __T29 = (cudaGetLastError()); if (0 != ((int)__T29)) { fprintf(stderr, ((const char *)"%s(%i) : cutilCheckMsg() CUTIL CUDA error : %s : %s.\n"), __T28, 102, __T27, (cudaGetErrorString(__T29))); exit((-1)); } } } 
}
static void __sti___17_u_updates_cpp1_ii_3947bc38(void) {   }

#include "u_updates.cudafe1.stub.c"
