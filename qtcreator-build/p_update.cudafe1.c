...
extern void launch_kernel_dual_variable_p(float *, float *, float *, float *, float, float, float, unsigned, unsigned, unsigned);
extern int __cudaSetupArgSimple();
extern int __cudaLaunch();
extern int __cudaRegisterBinary();
extern int __cudaRegisterEntry();
static void __sti___16_p_update_cpp1_ii_3bcee054(void) __attribute__((__constructor__));
...
# 46 "/home/ankur/workspace/code/Superresolution/./src/kernels/p_update.cu"
void launch_kernel_dual_variable_p( float *px,  float *py,  float *ux_,  float *uy_,  float epsilon_u,  float sigma,  float lambda, 
...
{ __T20 = (mesh_width / (__cuda_local_var_42964_10_non_const_block.x)); __T21 = (mesh_height / (__cuda_local_var_42964_10_non_const_block.y)); { (__cuda_local_var_42965_10_non_const_grid.x) = __T20; (__cuda_local_var_42965_10_non_const_grid.y) = __T21; (__cuda_local_var_42965_10_non_const_grid.z) = 1U; } }
(cudaConfigureCall(__cuda_local_var_42965_10_non_const_grid, __cuda_local_var_42964_10_non_const_block, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z12kernel_dualpPfS_S_S_fffj(px, py, ux_, uy_, epsilon_u, sigma, lambda, stride));
{ __T22 = ((const char *)"execution failed\n"); __T23 = ((const char *)"/home/ankur/workspace/code/Superresolution/./src/kernels/p_update.cu"); { __T24 = (cudaGetLastError()); if (0 != ((int)__T24)) { fprintf(stderr, ((const char *)"%s(%i) : cutilCheckMsg() CUTIL CUDA error : %s : %s.\n"), __T23, 53, __T22, (cudaGetErrorString(__T24))); exit((-1)); } } } 
}
static void __sti___16_p_update_cpp1_ii_3bcee054(void) {   }

#include "p_update.cudafe1.stub.c"
