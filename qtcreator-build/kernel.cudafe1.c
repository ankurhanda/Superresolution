...
enum _ZNSt12__is_integerIdEUt_E { _ZNSt12__is_integerIdE7__valueE}; enum _ZNSt12__is_integerIfEUt_E { _ZNSt12__is_integerIfE7__valueE};
...
extern void launch_kernel_derivative_u(float *, float *, float *, unsigned, unsigned, unsigned);
# 130 "/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"
extern void launch_kernel_update_u(float *, float *, float *, float *, float *, unsigned, unsigned, unsigned, float, float);
# 141 "/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"
extern void launch_kernel_dual_variable_p(float *, float *, float *, float *, float, unsigned, unsigned, unsigned);
extern int __cudaSetupArgSimple();
extern int __cudaLaunch();
extern int __cudaRegisterBinary();
extern int __cudaRegisterEntry();
static void __sti___14_kernel_cpp1_ii_9e61563c(void) __attribute__((__constructor__));
...
# 114 "/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"
void launch_kernel_derivative_u( float *ux_,  float *uy_,  float *u_,  unsigned stride,  unsigned mesh_width,  unsigned mesh_height)
{  unsigned __T20;
 unsigned __T21;
 const char *__T22;
 const char *__T23;
...
# 117 "/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"
 dim3 __cuda_local_var_43031_10_non_const_block;
 dim3 __cuda_local_var_43032_10_non_const_grid;
# 117 "/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"
{ (__cuda_local_var_43031_10_non_const_block.x) = 8U; (__cuda_local_var_43031_10_non_const_block.y) = 8U; (__cuda_local_var_43031_10_non_const_block.z) = 1U; }
{ __T20 = (mesh_width / (__cuda_local_var_43031_10_non_const_block.x)); __T21 = (mesh_height / (__cuda_local_var_43031_10_non_const_block.y)); { (__cuda_local_var_43032_10_non_const_grid.x) = __T20; (__cuda_local_var_43032_10_non_const_grid.y) = __T21; (__cuda_local_var_43032_10_non_const_grid.z) = 1U; } }


(cudaConfigureCall(__cuda_local_var_43032_10_non_const_grid, __cuda_local_var_43031_10_non_const_block, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z19kernel_derivative_uPfS_S_jjj(ux_, uy_, u_, stride, mesh_width, mesh_height));


{ __T22 = ((const char *)"execution failed\n"); __T23 = ((const char *)"/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"); { __T24 = (cudaGetLastError()); if (0 != ((int)__T24)) { fprintf(stderr, ((const char *)"%s(%i) : cutilCheckMsg() CUTIL CUDA error : %s : %s.\n"), __T23, 124, __T22, (cudaGetErrorString(__T24))); exit((-1)); } } } 


}


void launch_kernel_update_u( float *px,  float *py,  float *u,  float *u_,  float *g,  unsigned stride,  unsigned mesh_width,  unsigned mesh_height,  float tau,  float lambda)
{  unsigned __T25;
 unsigned __T26;
 const char *__T27;
 const char *__T28;
...
# 133 "/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"
 dim3 __cuda_local_var_43047_10_non_const_block;
 dim3 __cuda_local_var_43048_10_non_const_grid;
# 133 "/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"
{ (__cuda_local_var_43047_10_non_const_block.x) = 8U; (__cuda_local_var_43047_10_non_const_block.y) = 8U; (__cuda_local_var_43047_10_non_const_block.z) = 1U; }
{ __T25 = (mesh_width / (__cuda_local_var_43047_10_non_const_block.x)); __T26 = (mesh_height / (__cuda_local_var_43047_10_non_const_block.y)); { (__cuda_local_var_43048_10_non_const_grid.x) = __T25; (__cuda_local_var_43048_10_non_const_grid.y) = __T26; (__cuda_local_var_43048_10_non_const_grid.z) = 1U; } }
(cudaConfigureCall(__cuda_local_var_43048_10_non_const_grid, __cuda_local_var_43047_10_non_const_block, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z15kernel_update_uPfS_S_S_S_jjjff(px, py, u, u_, g, stride, mesh_width, mesh_height, tau, lambda));
{ __T27 = ((const char *)"execution failed\n"); __T28 = ((const char *)"/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"); { __T29 = (cudaGetLastError()); if (0 != ((int)__T29)) { fprintf(stderr, ((const char *)"%s(%i) : cutilCheckMsg() CUTIL CUDA error : %s : %s.\n"), __T28, 136, __T27, (cudaGetErrorString(__T29))); exit((-1)); } } } 
}



void launch_kernel_dual_variable_p( float *px,  float *py,  float *ux_,  float *uy_,  float sigma,  unsigned stride,  unsigned mesh_width,  unsigned mesh_height)
{  unsigned __T210;
 unsigned __T211;
 const char *__T212;
 const char *__T213;
...
# 144 "/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"
 dim3 __cuda_local_var_43058_10_non_const_block;
 dim3 __cuda_local_var_43059_10_non_const_grid;
# 144 "/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"
{ (__cuda_local_var_43058_10_non_const_block.x) = 8U; (__cuda_local_var_43058_10_non_const_block.y) = 8U; (__cuda_local_var_43058_10_non_const_block.z) = 1U; }
{ __T210 = (mesh_width / (__cuda_local_var_43058_10_non_const_block.x)); __T211 = (mesh_height / (__cuda_local_var_43058_10_non_const_block.y)); { (__cuda_local_var_43059_10_non_const_grid.x) = __T210; (__cuda_local_var_43059_10_non_const_grid.y) = __T211; (__cuda_local_var_43059_10_non_const_grid.z) = 1U; } }
(cudaConfigureCall(__cuda_local_var_43059_10_non_const_grid, __cuda_local_var_43058_10_non_const_block, 0UL, ((cudaStream_t)0LL))) ? ((void)0) : (__device_stub__Z12kernel_dualpPfS_S_S_fjjj(px, py, ux_, uy_, sigma, stride, mesh_width, mesh_height));
{ __T212 = ((const char *)"execution failed\n"); __T213 = ((const char *)"/home/ankur/workspace/code/Superresolution/./src/kernels/kernel.cu"); { __T214 = (cudaGetLastError()); if (0 != ((int)__T214)) { fprintf(stderr, ((const char *)"%s(%i) : cutilCheckMsg() CUTIL CUDA error : %s : %s.\n"), __T213, 147, __T212, (cudaGetErrorString(__T214))); exit((-1)); } } } 
}
static void __sti___14_kernel_cpp1_ii_9e61563c(void) {   }
